...
if __name__=="__main__":
    ...
    # A_task_vector = torch.load("MEET_Dec_ATT_MAVEN_temporal_cla_requests_yes_no_1.pth")  # 1, 2
    ...
    # B_task_vector = torch.load("MEET_Dec_ATT_MAVEN_temporal_ext_requests_yes_no_1.pth")  # 1, 2
    ...
    # A_task_vector = torch.load("MEET_Dec_ATT_MAVEN_subevent_cla_requests_yes_no_{}.pth".format(TASK_NUM))
    # A_task_w_names = list(A_task_vector.keys())
    # A_task_layers = np.array([int(one_name.split('.')[2]) for one_name in A_task_w_names])
    # # MEET_Enc_MLP_MAVEN_subevent_ext_requests_yes_no_1
    # # MEET_Dec_ATT_MAVEN_subevent_ext_requests_yes_no_1
    # B_task_vector = torch.load("MEET_Dec_ATT_MAVEN_subevent_ext_requests_yes_no_{}.pth".format(TASK_NUM))
    # B_task_w_names = list(B_task_vector.keys())
    # B_task_layers = np.array([int(one_name.split('.')[2]) for one_name in B_task_w_names])
    ...
    # MEET_Enc_MLP_MAVEN_subevent_cla_requests_yes_no_1
    # MEET_Dec_ATT_MAVEN_subevent_cla_requests_yes_no_1
    A_task_vector = torch.load("MEET_Dec_ATT_MAVEN_causal_cla_requests_yes_no_{}.pth".format(TASK_NUM))
    A_task_w_names = list(A_task_vector.keys())
    A_task_layers = np.array([int(one_name.split('.')[2]) for one_name in A_task_w_names])
    # MEET_Enc_MLP_MAVEN_subevent_ext_requests_yes_no_1
    # MEET_Dec_ATT_MAVEN_subevent_ext_requests_yes_no_1
    B_task_vector = torch.load("MEET_Dec_ATT_MAVEN_causal_ext_requests_yes_no_{}.pth".format(TASK_NUM))
    B_task_w_names = list(B_task_vector.keys())
    B_task_layers = np.array([int(one_name.split('.')[2]) for one_name in B_task_w_names])
    ...
    C_task_vector = torch.load("MEET_Dec_ATT_MAVEN_subevent_cla_requests_yes_no_{}.pth".format(TASK_NUM))  # 1, 2
