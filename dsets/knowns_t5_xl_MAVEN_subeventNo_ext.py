...
class KnownsDataset_t5_xl_MAVEN_subeventNo_ext(Dataset):
    def __init__(self, data_dir: str, *args, **kwargs):
        data_dir = Path(data_dir)
        # known_loc = data_dir / "known_1000.json"  # tjy
        known_loc = data_dir / "MAVEN_ERE/MAVEN_subeventNo_500_ext.json"  # tjy
