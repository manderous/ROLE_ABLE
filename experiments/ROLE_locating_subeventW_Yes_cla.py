...
from dsets import KnownsDataset_t5_xl_MAVEN_subevent_cla  # tjy
...
def main():
    ...
    aa("--output_dir", default="results/{model_name}/MAVEN/subeventW_Yes/classification")  # tjy: 这个文件夹记得随时更改，用于分类不同的任务
    ...
    if args.fact_file is None:
        knowns = KnownsDataset_t5_xl_MAVEN_subevent_cla(DATA_DIR)  # tjy
    else:
