...
from dsets import KnownsDataset_t5_xl_MAVEN_causalNo_cla
...
def main():
    ...
    aa("--output_dir", default="results/{model_name}/MAVEN/causalNoW_No/classification")  # tjy: 这个文件夹记得随时更改，用于分类不同的任务
